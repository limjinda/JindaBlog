        ...
        class Redux_Framework_sample_config {
            ...
            public function setArguments() {
                ...
                $this->args = array(
                    ...
                    'menu_title'           => __( 'Jinda Settings', 'jindaBlog' ),
                    'page_title'           => __( 'Jinda Settings', 'jindaBlog' ),
                ...
                $this->args['share_icons'][] = array(
                    'url'   => 'https://github.com/jir4yu/JindaBlog',
                    'title' => 'JindaBlog on GitHub',
                    'icon'  => 'el-icon-github'
                    //'img'   => '', // You can use icon OR img. IMG needs to be a full URL.
                );
                $this->args['share_icons'][] = array(
                    'url'   => 'https://www.facebook.com/byJir4yu',
                    'title' => 'Like us on Facebook',
                    'icon'  => 'el-icon-facebook'
                );
                $this->args['share_icons'][] = array(
                    'url'   => 'http://twitter.com/jir4yu',
                    'title' => 'Follow us on Twitter',
                    'icon'  => 'el-icon-twitter'
                );
                $this->args['share_icons'][] = array(
                    'url'   => 'https://www.linkedin.com/in/jir4yu',
