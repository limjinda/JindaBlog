...
function jinda_scripts() {
	...
	wp_register_script('jquery', get_stylesheet_directory_uri() . '/bower_components/jquery/dist/jquery.min.js#asyncload', array(), '2.0.0', true);
	wp_enqueue_script('jquery');
	wp_enqueue_script('modernizr', get_stylesheet_directory_uri() . '/bower_components/modernizr/modernizr.js#asyncload', array('jquery'), '2.0.0', true);
	wp_enqueue_script('trmix', get_stylesheet_directory_uri() . '/bower_components/trmix/dist/trmix.min.js#asyncload', array('jquery'), '2.0.0', true);
	wp_enqueue_script('uikit', get_stylesheet_directory_uri() . '/bower_components/uikit/js/uikit.min.js#asyncload', array('jquery'), '2.0.0', true);
	wp_enqueue_script('jquery-browser', get_stylesheet_directory_uri() . '/bower_components/jquery.browser/dist/jquery.browser.min.js#asyncload', array('jquery'), '2.0.0', true);
	wp_enqueue_script('jindablog-core-js', get_stylesheet_directory_uri() . '/js/global.js#asyncload', array('jquery'), '2.0.0', true);
}
