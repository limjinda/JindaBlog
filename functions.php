...
function jinda_scripts() {
	...
	wp_enqueue_style('jindablog-core', get_stylesheet_uri(), array(), '2.0.1' );
	...
	wp_enqueue_script('jindablog-core-js', get_stylesheet_directory_uri() . '/js/global.js', array('jquery'), '2.0.2', true);
}
