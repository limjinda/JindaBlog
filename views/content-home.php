<div class="uk-width-1-1 uk-width-small-1-2 uk-width-medium-1-1 uk-width-large-1-2 post-block">
	<article class="uk-article">
		...
		<p class="post-excerpt"><?= iconv_substr(get_the_excerpt(),0,180,"UTF-8").' '; ?> <a href="<?php the_permalink(); ?>" title="<?php the_title(); ?>" class="more-text"><?php _e('read more', 'jindaBlog'); ?></a></p>
